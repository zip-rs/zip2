...
impl CentralDirectoryEnd {
    ...
    pub async fn parse_async<T: io::AsyncRead>(mut reader: Pin<&mut T>) -> ZipResult<(CentralDirectoryEnd, u64)> {
        static_assertions::assert_eq_size!([u8; 22], CentralDirectoryEndBuffer);
    {
        ...
        let search_upper_bound =
            file_length.saturating_sub(Self::HEADER_SIZE + u16::MAX as u64);
