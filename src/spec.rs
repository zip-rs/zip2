...
/// [`FileOptions::large_file()`](crate::write::FileOptions) was not true, then [`ZipWriter`](crate::write::ZipWriter) will
...
/// directory record.
///
/// If more than this number of entries is written to a [`ZipWriter`](crate::write::ZipWriter), then [`ZipWriter::finish()`](crate::write::ZipWriter::finish)
