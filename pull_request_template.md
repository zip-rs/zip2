...
- This codebase sometimes changes rapidly. Please rebase your branch before opening a pull request, and 
  ...
  - [An open PR has the "major" label](https://github.com/zip-rs/zip2/pulls?q=is%3Apr+is%3Aopen+label%3Amajor),
    ...
    until they're merged before starting development on a new PR of nontrivial size will save you some work on resolving
    merge conflicts and likely shorten the lead time to get your PR reviewed.
